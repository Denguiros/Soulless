...
namespace Control
{
    ...
    public class AnimatorHandler : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            vertical = Animator.StringToHash(PlayerAnimatorParameters.Vertical.ToString());
            horizontal = Animator.StringToHash(PlayerAnimatorParameters.Horizontal.ToString());
